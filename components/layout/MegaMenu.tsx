                                ...
                                <ul className="flex flex-col gap-3">
                                    {items.map((item) => (
                                        <li key={item.label}>
                                            <Link
                                                href={item.href}
                                                className="text-[15px] font-normal text-neutral-800 hover:text-red-600 transition-colors block"
                                            >
                                                {item.label}
                                            </Link>
                                        </li>
                                ...
                                <div className="grid grid-cols-3 gap-6">
                                    {cards.map((card) => (
                                        <Link key={card.title} href={card.href} className="group block">
                                            ...
                                            <h3 className="text-base font-bold text-neutral-900 group-hover:text-red-600 transition-colors mb-1">
                                                {card.title}
                                            </h3>
